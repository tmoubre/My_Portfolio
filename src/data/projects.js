...
const projects = [
  {
    ...
    description:
      "A multi‑page, responsive website (Home, About, Work, Contact) that showcases my projects and makes it easy to get in touch. Built with semantic HTML and accessible CSS so it looks good and works well on any device. This was just an exercise not a complete project.",
    stack: ["HTML", "CSS"],
    links: {
