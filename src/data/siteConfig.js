export const GITHUB = 'https://github.com/tmoubre';
export const LINKEDIN = 'https://www.linkedin.com/in/troy-oubre-32170a32/';
export const MEDIUM = 'https://medium.com/@scinetbr';
export const X = 'https://x.com/troydevelops';
