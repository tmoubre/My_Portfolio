...
const SOCIAL_LINKS = [
    { label: 'GitHub', href: 'https://github.com/tmoubre', className: 'social-github', icon: FaGithub },
    { label: 'LinkedIn', href: 'https://www.linkedin.com/in/troy-oubre-32170a32/', className: 'social-linkedin', icon: FaLinkedinIn },
    { label: 'Medium', href: 'https://medium.com/@scinetbr', className: 'social-medium', icon: FaMedium },
    { label: 'X', href: 'https://x.com/troydevelops', className: 'social-x', icon: FaXTwitter },
];

export default function SiteNavigation({ activeNav, onNavigate }) {
    const runAction = (id) => () => onNavigate(id);
